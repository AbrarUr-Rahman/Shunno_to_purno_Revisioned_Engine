...
@onready var male_border: Button = $Cards/MaleButton/BorderGlow
@onready var female_border: Button = $Cards/FemaleButton/BorderGlow
...
func _pop_up_card(card: TextureButton):
	...
	if selected_card == "male":
		...
		#tween.tween_property(male_border, "scale", Vector2(1, 1), 0.1)
		tween.tween_property(female_button, "scale", Vector2(1, 1), 0.1)
	elif selected_card == "female":
		tween.tween_property(card, "scale", Vector2(1.02, 1.02), 0.1)	
		#tween.tween_property(female_border, "scale", Vector2(1, 1), 0.1)
